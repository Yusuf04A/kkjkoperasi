                ...
                <div className="relative z-10 text-left">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div className="flex flex-col">
                            <span className="font-black tracking-[0.2em] text-lg uppercase text-white leading-none">
                                KOPERASI
                            </span>
                            <span className="font-black tracking-[0.2em] text-lg uppercase text-[#aeea00] leading-none mt-1">
                                KKJ
                            </span>
                        </div>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white relative overflow-y-auto">
                ...
                <div className="w-full max-w-md space-y-6">
                    ...
                    <div className="text-left hidden lg:block mb-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500 font-medium">Lengkapi data diri Anda untuk mendaftar</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4 text-left">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Input
                                ...
                                required
                                className="focus:ring-[#5db930] focus:border-[#5db930] bg-gray-50 border-gray-200 pl-10 py-4 rounded-xl text-sm"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    required
                                    className={cn(
                                        "focus:ring-[#5db930] focus:border-[#5db930] bg-gray-50 border-gray-200 pl-10 pr-12 py-4 rounded-xl text-sm transition-all",
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 rounded-xl bg-gradient-to-t from-[#5db930] to-[#76d646] text-white font-black text-lg shadow-[0_4px_0px_#4a9c22] hover:translate-y-0.5 active:shadow-none active:translate-y-[4px] transition-all tracking-wider uppercase flex items-center justify-center gap-2 mt-6 disabled:opacity-50"
                        >
