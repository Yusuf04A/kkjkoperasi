        ...
        <div className="min-h-screen bg-gray-50 pb-24 font-sans text-slate-900 text-left lowercase">
            ...
            <div className="max-w-xl mx-auto p-4 space-y-6">
                ...
                <div className="space-y-3">
                    <h2 className="text-xs font-bold text-[#136f42] uppercase tracking-wider pl-1">Transfer ke Rekening Resmi</h2>
                    {bankAccounts.map((bank, idx) => (
                        <div key={idx} className="bg-white p-5 rounded-2xl border border-green-100 shadow-sm flex justify-between items-center">
                            <div>
                                <p className="text-[10px] font-black text-[#136f42] bg-green-50 w-fit px-2 py-0.5 rounded mb-1 uppercase tracking-wide">{bank.name}</p>
                            ...
                            <button onClick={() => handleCopy(bank.number)} className="p-2.5 text-gray-400 hover:text-[#136f42] hover:bg-green-50 rounded-xl transition-all uppercase"><Copy size={20} /></button>
                        </div>
                    ))}
                ...
                <form onSubmit={handlePreSubmit} className="bg-white p-6 rounded-2xl border border-green-100 shadow-sm space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-[#136f42] py-6 text-lg rounded-xl font-bold uppercase tracking-wider">
            ...
            {isQrModalOpen && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-md">
                    <div className="bg-white w-full max-w-sm rounded-[2.5rem] p-8 relative animate-in zoom-in-95">
                        <button onClick={() => setIsQrModalOpen(false)} className="absolute top-6 right-6 p-2 text-slate-300 hover:text-rose-500 transition-colors uppercase"><X size={24}/></button>
                        <div className="text-center space-y-6">
                            <div className="space-y-1">
                                <h2 className="text-xl font-black text-slate-800 uppercase tracking-tight">Scan QRIS</h2>
                        ...
                        {isPinNotSet ? (
                            ...
                            <>
                                ...
                                <Button 
                                    ...
                                    className="w-full bg-[#136f42] py-4 rounded-2xl font-black uppercase text-xs tracking-widest shadow-lg active:scale-95 transition-all"
                                >
                                    konfirmasi & kirim
                                </Button>
                            </>
