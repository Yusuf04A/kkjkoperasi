...
export const TopUp = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24 font-sans text-slate-900">
            ...
            {/* --- MODAL PIN DENGAN FITUR VIEW (MATA) --- */}
            {isPinModalOpen && (
                    ...
                    <div className="bg-white w-full max-w-sm rounded-[2.5rem] p-8 shadow-2xl space-y-6 animate-in zoom-in-95">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center text-[#136f42]"><Lock size={20}/></div>
                        ...
                        <div className="space-y-4">
                            <p className="text-xs text-slate-400 font-medium leading-relaxed">Masukkan 6 digit PIN transaksi Anda untuk mengonfirmasi pengajuan Top Up ini.</p>
                            
                            <div className="relative group">
                                <input
                                    type={showPin ? "text" : "password"} // 🔥 FITUR VIEW PIN 🔥
                                    maxLength={6}
                                    placeholder="******"
                                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-4 text-2xl font-black tracking-[0.5em] focus:ring-4 focus:ring-green-50 focus:border-[#136f42] outline-none transition-all text-center"
                                    value={pin}
                            ...
                            <Button
                                ...
                                className="w-full bg-[#136f42] hover:bg-[#0f5c35] py-4 rounded-2xl font-black uppercase text-xs tracking-widest shadow-lg shadow-green-900/20"
                            >
                                Konfirmasi & Kirim
                            </Button>
                        </div>
